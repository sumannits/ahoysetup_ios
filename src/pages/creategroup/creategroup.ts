...
export class CreategroupPage {
  ...
  public addDetails(data:any){
    ...
    this.dataService.postData(data,'UserGroups').then((result:any) => {
      ...
      if(lastGrpId){
        ...
        let IntReportData = {"type":1,"description":' has create a group "'+data.name+'"',"is_delete":0,"customerId":this.userData.id,"notification_pid":this.insertDataId};
